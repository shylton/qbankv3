 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zf(n,t,e){let r;return r=n?e&&(e.merge||e.mergeFields)?n.toFirestore(t,e):n.toFirestore(t):t,r}function td(n,t){const e=za(n.firestore,Qa),r=Uf(n),s=Zf(n.converter,t);return ed(e,[Kf(Gf(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,jt.exists(!1))]).then(()=>r)}function ed(n,t){return function(r,s){const o=new ce;return r.asyncQueue.enqueueAndForget(async()=>Rf(await xf(r),s,o)),o.promise}(qf(n),t)}(function(t,e=!0){(function(s){Ue=s})(dc),or(new yn("firestore",(r,{instanceIdentifier:s,options:o})=>{const l=r.getProvider("app").getImmediate(),c=new Qa(new Sc(r.getProvider("auth-internal")),new kc(r.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new H(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new cr(d.options.projectId,m)}(l,s),l);return o=Object.assign({useFetchStreams:e},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),Ce(to,"4.6.3",t),Ce(to,"4.6.3","esm2017")})();const nd={apiKey:"AIzaSyA9n2z7PWBv46uONKZ0sQRr-zAyWtNC93U",authDomain:"svelte-todo-fireship-ebe79.firebaseapp.com",projectId:"svelte-todo-fireship-ebe79",storageBucket:"svelte-todo-fireship-ebe79.appspot.com",messagingSenderId:"800590283445",appId:"1:800590283445:web:dd71c566728aa4ecfc74fc"},rd=Wo(nd),id=$f(rd);function Ro(n){let t,e,r,s,o,l;return{c(){t=F("div"),e=F("span"),r=rt(`:
      `),s=F("span"),o=rt(`:
      `),l=F("span"),we(e,"--value",n[5]),we(s,"--value",n[4]),we(l,"--value",n[6]),N(t,"class","countdown font-mono flex items-center space-x-1")},m(c,h){z(c,t,h),V(t,e),V(t,r),V(t,s),V(t,o),V(t,l)},p(c,h){h&32&&we(e,"--value",c[5]),h&16&&we(s,"--value",c[4]),h&64&&we(l,"--value",c[6])},d(c){c&&q(t)}}}function sd(n){let t,e,r;return{c(){t=F("button"),t.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M713-600 600-713l56-57 57 57 141-142 57 57-198 198ZM200-120v-640q0-33 23.5-56.5T280-840h280q-20 30-30 57.5T520-720q0 72 45.5 127T680-524q23 3 40 3t40-3v404L480-240 200-120Z"></path></svg>',N(t,"class","ml-2")},m(s,o){z(s,t,o),e||(r=Rt(t,"click",n[8]),e=!0)},p:at,d(s){s&&q(t),e=!1,r()}}}function od(n){let t,e,r;return{c(){t=F("button"),t.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M200-120v-640q0-33 23.5-56.5T280-840h240v80H280v518l200-86 200 86v-278h80v400L480-240 200-120Zm80-640h240-240Zm400 160v-80h-80v-80h80v-80h80v80h80v80h-80v80h-80Z"></path></svg>',N(t,"class","ml-2")},m(s,o){z(s,t,o),e||(r=Rt(t,"click",n[8]),e=!0)},p:at,d(s){s&&q(t),e=!1,r()}}}function ad(n){let t,e,r,s,o,l,c,h,d,m,E,b,R=n[3]&&Ro(n);function D(B,L){return B[1]?sd:od}let x=D(n),S=x(n);return{c(){t=F("div"),R&&R.c(),e=K(),r=F("div"),s=F("div"),o=rt(n[0]),l=rt(" of "),c=rt(n[2]),h=K(),S.c(),d=K(),m=F("button"),m.textContent="Abort",N(s,"class","mr-2"),N(r,"class","flex items-center"),N(m,"class","btn btn-sm w-32 ml-4"),N(t,"class","bg-teal-950 text-white text-lg font-bold p-4 flex items-center justify-between")},m(B,L){z(B,t,L),R&&R.m(t,null),V(t,e),V(t,r),V(r,s),V(s,o),V(s,l),V(s,c),V(r,h),S.m(r,null),V(t,d),V(t,m),E||(b=Rt(m,"click",n[7]),E=!0)},p(B,[L]){B[3]?R?R.p(B,L):(R=Ro(B),R.c(),R.m(t,e)):R&&(R.d(1),R=null),L&1&&xt(o,B[0]),L&4&&xt(c,B[2]),x===(x=D(B))&&S?S.p(B,L):(S.d(1),S=x(B),S&&(S.c(),S.m(r,null)))},i:at,o:at,d(B){B&&q(t),R&&R.d(),S.d(),E=!1,b()}}}function ld(n,t,e){let r,s,o,l,{QNumber:c}=t,{bookmarked:h}=t,{totalQuestions:d=0}=t,{useTimer:m}=t;const E=wi();let b=Date.now(),R=b+d*70*1e3,D=m?setInterval(S,1e3):!1;function x(){clearInterval(D),E("abort")}function S(){e(9,b=Date.now())}function B(){E("bookmark",{mark:!h})}return Uo(()=>{clearInterval(D)}),n.$$set=L=>{"QNumber"in L&&e(0,c=L.QNumber),"bookmarked"in L&&e(1,h=L.bookmarked),"totalQuestions"in L&&e(2,d=L.totalQuestions),"useTimer"in L&&e(3,m=L.useTimer)},n.$$.update=()=>{n.$$.dirty&512&&e(10,r=Math.round((R-b)/1e3)),n.$$.dirty&1024&&e(5,s=Math.floor(r/3600)),n.$$.dirty&1056&&e(4,o=Math.floor((r-s*3600)/60)),n.$$.dirty&1072&&e(6,l=r-s*3600-o*60),n.$$.dirty&1024&&r===0&&(alert("Time's up!"),x())},[c,h,d,m,o,s,l,x,B,b,r]}class ud extends Fe{constructor(t){super(),Le(this,t,ld,ad,xe,{QNumber:0,bookmarked:1,totalQuestions:2,useTimer:3})}}function Po(n,t,e){const r=n.slice();return r[6]=t[e],r[8]=e,r}function So(n){let t,e=String.fromCharCode(65+n[8])+"",r,s,o=n[6]+"",l,c,h,d;function m(){return n[4](n[8])}return{c(){t=F("button"),r=rt(e),s=rt(". "),l=rt(o),N(t,"class",c="btn "+(n[1]===n[8]?"btn-active btn-ghost":"btn-ghost")+" w-full svelte-1yxs5au")},m(E,b){z(E,t,b),V(t,r),V(t,s),V(t,l),h||(d=Rt(t,"click",m),h=!0)},p(E,b){n=E,b&1&&o!==(o=n[6]+"")&&xt(l,o),b&2&&c!==(c="btn "+(n[1]===n[8]?"btn-active btn-ghost":"btn-ghost")+" w-full svelte-1yxs5au")&&N(t,"class",c)},d(E){E&&q(t),h=!1,d()}}}function cd(n){let t,e,r=n[0].prompt+"",s,o,l=n[0].answers,c=[];for(let h=0;h<l.length;h+=1)c[h]=So(Po(n,l,h));return{c(){t=F("div"),e=F("p"),s=rt(r),o=K();for(let h=0;h<c.length;h+=1)c[h].c();N(e,"class","text-lg my-2"),N(t,"class","container")},m(h,d){z(h,t,d),V(t,e),V(e,s),V(t,o);for(let m=0;m<c.length;m+=1)c[m]&&c[m].m(t,null)},p(h,[d]){if(d&1&&r!==(r=h[0].prompt+"")&&xt(s,r),d&15){l=h[0].answers;let m;for(m=0;m<l.length;m+=1){const E=Po(h,l,m);c[m]?c[m].p(E,d):(c[m]=So(E),c[m].c(),c[m].m(t,null))}for(;m<c.length;m+=1)c[m].d(1);c.length=l.length}},i:at,o:at,d(h){h&&q(t),nr(c,h)}}}function hd(n,t,e){let r,{curQuestion:s}=t;const o=wi();function l(d){e(1,r=d)}function c(d){o("chosenAnswer",d)}const h=d=>{c(d),l(d)};return n.$$set=d=>{"curQuestion"in d&&e(0,s=d.curQuestion)},n.$$.update=()=>{n.$$.dirty&1&&e(1,r=s.userChoice??-1)},[s,r,l,c,h]}class fd extends Fe{constructor(t){super(),Le(this,t,hd,cd,xe,{curQuestion:0})}}function dd(n){let t,e,r,s,o,l,c,h;return{c(){t=F("div"),e=K(),r=F("nav"),s=F("button"),s.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M21 16.811c0 .864-.933 1.406-1.683.977l-7.108-4.061a1.125 1.125 0 0 1 0-1.954l7.108-4.061A1.125 1.125 0 0 1 21 8.689v8.122ZM11.25 16.811c0 .864-.933 1.406-1.683.977l-7.108-4.061a1.125 1.125 0 0 1 0-1.954l7.108-4.061a1.125 1.125 0 0 1 1.683.977v8.122Z"></path></svg>
    Prev`,o=K(),l=F("button"),l.innerHTML=`Next
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 0 1 0 1.954l-7.108 4.061A1.125 1.125 0 0 1 3 16.811V8.69ZM12.75 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 0 1 0 1.954l-7.108 4.061a1.125 1.125 0 0 1-1.683-.977V8.69Z"></path></svg>`,N(t,"class","divider"),N(s,"class","btn btn-lg mx-1"),N(l,"class","btn btn-lg mx-1"),N(r,"class","navbar bg-base-500 flex flex-row justify-center")},m(d,m){z(d,t,m),z(d,e,m),z(d,r,m),V(r,s),V(r,o),V(r,l),c||(h=[Rt(s,"click",n[1]),Rt(l,"click",n[0])],c=!0)},p:at,i:at,o:at,d(d){d&&q(t),d&&q(e),d&&q(r),c=!1,ee(h)}}}function pd(n){const t=wi();function e(){t("nextQuestion",{})}function r(){t("prevQuestion",{})}return[e,r]}class md extends Fe{constructor(t){super(),Le(this,t,pd,dd,xe,{})}}function Co(n,t,e){const r=n.slice();return r[3]=t[e],r}function gd(n){let t,e,r,s,o=n[3].bookmarked&&Vo();return{c(){t=F("div"),e=F("span"),e.textContent="Incorrect",r=K(),s=F("span"),o&&o.c(),N(t,"class","flex flex-row text-lg text-red-500 font-bold")},m(l,c){z(l,t,c),V(t,e),V(t,r),V(t,s),o&&o.m(s,null)},p(l,c){l[3].bookmarked?o||(o=Vo(),o.c(),o.m(s,null)):o&&(o.d(1),o=null)},d(l){l&&q(t),o&&o.d()}}}function _d(n){let t,e,r,s,o=n[3].bookmarked&&Do();return{c(){t=F("div"),e=F("span"),e.textContent="Correct",r=K(),s=F("span"),o&&o.c(),N(t,"class","flex flex-row text-lg text-green-500 font-bold")},m(l,c){z(l,t,c),V(t,e),V(t,r),V(t,s),o&&o.m(s,null)},p(l,c){l[3].bookmarked?o||(o=Do(),o.c(),o.m(s,null)):o&&(o.d(1),o=null)},d(l){l&&q(t),o&&o.d()}}}function Vo(n){let t,e,r;return{c(){t=Ut("svg"),e=Ut("path"),r=Ut("path"),N(e,"d","M200-120v-640q0-33 23.5-56.5T280-840h400q33 0 56.5 23.5T760-760v640L480-240 200-120Zm80-122 200-86 200 86v-518H280v518Zm0-518h400-400Z"),N(e,"fill","#F19E39"),N(r,"d","M280-760v518l200-86 200 86v-518H280Z"),N(r,"fill","#F19E39"),N(t,"xmlns","http://www.w3.org/2000/svg"),N(t,"height","24px"),N(t,"viewBox","0 -960 960 960"),N(t,"width","24px")},m(s,o){z(s,t,o),V(t,e),V(t,r)},d(s){s&&q(t)}}}function Do(n){let t,e,r;return{c(){t=Ut("svg"),e=Ut("path"),r=Ut("path"),N(e,"d","M200-120v-640q0-33 23.5-56.5T280-840h400q33 0 56.5 23.5T760-760v640L480-240 200-120Zm80-122 200-86 200 86v-518H280v518Zm0-518h400-400Z"),N(e,"fill","#F19E39"),N(r,"d","M280-760v518l200-86 200 86v-518H280Z"),N(r,"fill","#F19E39"),N(t,"xmlns","http://www.w3.org/2000/svg"),N(t,"height","24px"),N(t,"viewBox","0 -960 960 960"),N(t,"width","24px")},m(s,o){z(s,t,o),V(t,e),V(t,r)},d(s){s&&q(t)}}}function ko(n){let t,e,r=n[3].prompt+"",s,o,l,c,h,d=n[3].answers[n[3].correct]+"",m,E,b,R=n[3].answers[n[3].userChoice]+"",D,x,S,B,L,O,U=n[3].rationale+"",M,j,y,p,_,v,T;function A(Q,lt){return Q[3].correct===Q[3].userChoice?_d:gd}let g=A(n),ut=g(n);return{c(){ut.c(),t=K(),e=F("p"),s=rt(r),o=K(),l=F("p"),c=F("em"),h=rt("Correct Answer: "),m=rt(d),E=F("br"),b=rt(`
          Your Answer: `),D=rt(R),x=K(),S=F("div"),B=F("b"),B.textContent="Rationale:",L=F("br"),O=new Bl(!1),M=K(),j=F("p"),y=F("a"),p=rt("Learn more"),v=K(),T=F("div"),O.a=null,N(y,"class","link"),N(y,"href",_=n[3].source),N(y,"target","_blank"),N(y,"rel","noopener noreferrer"),N(T,"class","divider divider-info")},m(Q,lt){ut.m(Q,lt),z(Q,t,lt),z(Q,e,lt),V(e,s),z(Q,o,lt),z(Q,l,lt),V(l,c),V(c,h),V(c,m),V(c,E),V(c,b),V(c,D),z(Q,x,lt),z(Q,S,lt),V(S,B),V(S,L),O.m(U,S),z(Q,M,lt),z(Q,j,lt),V(j,y),V(y,p),z(Q,v,lt),z(Q,T,lt)},p(Q,lt){g===(g=A(Q))&&ut?ut.p(Q,lt):(ut.d(1),ut=g(Q),ut&&(ut.c(),ut.m(t.parentNode,t))),lt&1&&r!==(r=Q[3].prompt+"")&&xt(s,r),lt&1&&d!==(d=Q[3].answers[Q[3].correct]+"")&&xt(m,d),lt&1&&R!==(R=Q[3].answers[Q[3].userChoice]+"")&&xt(D,R),lt&1&&U!==(U=Q[3].rationale+"")&&O.p(U),lt&1&&_!==(_=Q[3].source)&&N(y,"href",_)},d(Q){ut.d(Q),Q&&q(t),Q&&q(e),Q&&q(o),Q&&q(l),Q&&q(x),Q&&q(S),Q&&q(M),Q&&q(j),Q&&q(v),Q&&q(T)}}}function yd(n){let t,e,r,s,o,l,c,h,d,m,E=n[0].length+"",b,R,D,x,S,B,L,O,U=n[0],M=[];for(let j=0;j<U.length;j+=1)M[j]=ko(Co(n,U,j));return{c(){t=F("button"),t.textContent="Print Results",e=K(),r=F("article"),s=F("div"),o=F("h1"),o.textContent="Results",l=K(),c=F("h3"),h=rt("Your Score is "),d=rt(n[1]),m=rt(" out of "),b=rt(E),R=K(),D=F("div"),D.textContent=`${n[2].toString()}`,x=K(),S=F("hr"),B=K();for(let j=0;j<M.length;j+=1)M[j].c();N(t,"class","btn"),N(o,"class","bg-slate-600 text-neutral-50 p-2 text-center"),N(D,"class","text-sm mb-4"),N(s,"class","container p-2"),N(r,"class","prose"),N(r,"id","printArea")},m(j,y){z(j,t,y),z(j,e,y),z(j,r,y),V(r,s),V(s,o),V(s,l),V(s,c),V(c,h),V(c,d),V(c,m),V(c,b),V(s,R),V(s,D),V(s,x),V(s,S),V(s,B);for(let p=0;p<M.length;p+=1)M[p]&&M[p].m(s,null);L||(O=Rt(t,"click",vd),L=!0)},p(j,[y]){if(y&2&&xt(d,j[1]),y&1&&E!==(E=j[0].length+"")&&xt(b,E),y&1){U=j[0];let p;for(p=0;p<U.length;p+=1){const _=Co(j,U,p);M[p]?M[p].p(_,y):(M[p]=ko(_),M[p].c(),M[p].m(s,null))}for(;p<M.length;p+=1)M[p].d(1);M.length=U.length}},i:at,o:at,d(j){j&&q(t),j&&q(e),j&&q(r),nr(M,j),L=!1,O()}}}function vd(){const n=document.getElementById("printArea").innerHTML,t=window.open("","_blank","width=800,height=600");t.document.write(`
        <html>
            <head>
